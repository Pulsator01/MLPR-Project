...
alphas = np.logspace(-3, 3, 50)  # Range of alphas: 0.001 to 1000
meta_model = RidgeCV(alphas=alphas, store_cv_values=True)
meta_model.fit(X_meta, y_base)

print(f"Best alpha for Ridge: {meta_model.alpha_:.4f}")
